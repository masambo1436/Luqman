                    ...
                    <div class="sidebar">
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                ...
                                <?php 
					$selfdevelopment = get_category("selfdevelopment",1,16, false); 
					if(count($selfdevelopment) > 1){
					?>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $selfdevelopment[0]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $selfdevelopment[0]->title; ?></h6>
                                                <span><?php echo $selfdevelopment[0]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $selfdevelopment[1]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $selfdevelopment[1]->title; ?></h6>
                                                <span><?php echo $selfdevelopment[1]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $selfdevelopment[2]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $selfdevelopment[2]->title; ?></h6>
                                                <span><?php echo $selfdevelopment[2]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
