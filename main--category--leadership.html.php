					...
					?>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $leadership[0]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $leadership[0]->title; ?></h6>
                                                <span><?php echo $leadership[0]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $leadership[1]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $leadership[1]->title; ?></h6>
                                                <span><?php echo $leadership[1]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $leadership[2]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $leadership[2]->title; ?></h6>
                                                <span><?php echo $leadership[2]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
