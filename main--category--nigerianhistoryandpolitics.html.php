            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2>Nigerian History and Politics Books</h2>
                        <div class="breadcrumb__option">
                            <a href="<?php echo site_url(); ?>">Home</a>
                            <span>Nigerian History and Politics</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="sidebar">
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                ...
                                <?php 
					$nigerianhistoryandpoliticsNigerian History and Politics = get_category("nigerianhistoryandpoliticsNigerian History and Politics",1,16, false); 
					if(count($nigerianhistoryandpoliticsNigerian History and Politics) > 1){
					?>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $nigerianhistoryandpoliticsNigerian History and Politics[0]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $nigerianhistoryandpoliticsNigerian History and Politics[0]->title; ?></h6>
                                                <span><?php echo $nigerianhistoryandpoliticsNigerian History and Politics[0]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $nigerianhistoryandpoliticsNigerian History and Politics[1]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $nigerianhistoryandpoliticsNigerian History and Politics[1]->title; ?></h6>
                                                <span><?php echo $nigerianhistoryandpoliticsNigerian History and Politics[1]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $nigerianhistoryandpoliticsNigerian History and Politics[2]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $nigerianhistoryandpoliticsNigerian History and Politics[2]->title; ?></h6>
                                                <span><?php echo $nigerianhistoryandpoliticsNigerian History and Politics[2]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                        <div class="section-title product__discount__title">
                            <h2>Nigerian History and Politics</h2>
                        </div>
