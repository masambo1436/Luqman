            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2>Bussiness and Finance Books</h2>
                        <div class="breadcrumb__option">
                            <a href="<?php echo site_url(); ?>">Home</a>
                            <span>Bussiness and Finance</span>
                        </div>
                    </div>
                </div>
            </div>
					...
					?>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $bussinessandfinance[0]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $bussinessandfinance[0]->title; ?></h6>
                                                <span><?php echo $bussinessandfinance[0]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $bussinessandfinance[1]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $bussinessandfinance[1]->title; ?></h6>
                                                <span><?php echo $bussinessandfinance[1]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width:70px;height:70px;">
                                                <img src="<?php echo $bussinessandfinance[2]->image; ?>" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?php echo $bussinessandfinance[2]->title; ?></h6>
                                                <span><?php echo $bussinessandfinance[2]->tag; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
